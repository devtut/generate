<template>
  <div>
    ...
    <div class="cards">
      <div class="card" v-for="language in filteredLanguages" :key="language.id">
  ...
  data() {
    return {
      ...
      languages: [
        ...
        { id: 4, name: "Java", topics: 185, url: "/java/" },
        { id: 5, name: "C", topics: 63, url: "/c/" },
        ...
        { id: 35, name: "LaTex", topics: 17, url: "/latex/" },
        { id: 36, name: "Linux", topics: 21, url: "/linux/" },
        { id: 37, name: "MATLAB", topics: 34, url: "/matlab/" },
        { id: 38, name: "Objective-C", topics: 34, url: "/objectivec/" },
