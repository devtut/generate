...
The Python interpreter compiles code to bytecode before executing it on the Python's virtual machine (see also [What is python bytecode?](http://web.archive.org/web/20170816202357/http://stackoverflow.com/documentation/python/1763/the-dis-module/5729/what-is-python-bytecode#t=201609280954269606205)).
...
The function [`dis.dis`](http://web.archive.org/web/20170816202357/https://docs.python.org/2/library/dis.html#dis.dis) in the [dis module](http://web.archive.org/web/20170816202357/http://stackoverflow.com/documentation/python/1763/the-dis-module) will return a decompiled bytecode of the function passed to it.
...
The source code for Python's built-in functions is written in **c** and can only be accessed by looking at the Python's source code (hosted on [Mercurial](http://web.archive.org/web/20170816202357/https://hg.python.org/) or downloadable from [https://www.python.org/downloads/source/)](http://web.archive.org/web/20170816202357/https://www.python.org/downloads/source/)).
