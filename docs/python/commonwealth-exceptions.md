...
**Note**: if you want use an unknown number of arguments, you can use `*args` or `**kwargs`. See [*args and **kwargs](http://web.archive.org/web/20170504091452/http://stackoverflow.com/documentation/python/2475/args-and-kwargs#t=201703011624312141911)
...
See [this](http://web.archive.org/web/20170504091452/http://stackoverflow.com/a/1017404/7237719) question if you want to learn more.
...
Because [the `print` statement was replaced with the `print()` function](http://web.archive.org/web/20170504091452/https://docs.python.org/3/whatsnew/3.0.html#print-is-a-function), so you want:
